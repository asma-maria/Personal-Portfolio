        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            ...
            <div className='mb-4 mt-8'>
                ...
                <a href="mailto:asmamaria4@gmail.com" className='hover:underline'>
                    asmamaria4@gmail.com
                </a>

            </div>
            <div className='mb-4'>
            <FaLinkedin className='inline-block text-green-400 mr-2'></FaLinkedin>
            <a href="https://www.linkedin.com/in/asma-akter-maria/">Linkedin Profile</a>
            </div>
            <div className='mb-4'>
                <FaPhone className='inline-block text-green-400 mr-2'></FaPhone>
                <span>+880 1881880000</span>
            </div>
            <div className='mb-4'>
                <FaMapMarkedAlt className='inline-block text-green-400 mr-2'></FaMapMarkedAlt>
                <span> Road No.7,Rupatoli Housing Estate, Barishal Sadar.</span>
            </div>
          </div>
